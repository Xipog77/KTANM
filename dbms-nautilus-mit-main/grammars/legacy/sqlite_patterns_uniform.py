...
ctx.rule("Sql-Stmt", "{Update-Stmt}", weight=1.0)
ctx.rule("Sql-Stmt", "{Delete-Stmt}", weight=1.0)
ctx.rule("Sql-Stmt", "{Create-Table-Stmt}", weight=1.0)
ctx.rule("Sql-Stmt", "{Create-Index-Stmt}", weight=1.0)
ctx.rule("Sql-Stmt", "{Create-View-Stmt}", weight=1.0)
ctx.rule("Sql-Stmt", "{Create-Trigger-Stmt}", weight=1.0)
ctx.rule("Sql-Stmt", "{Create-Virtual-Table-Stmt}", weight=1.0)
ctx.rule("Sql-Stmt", "{Drop-Stmt}", weight=1.0)
ctx.rule("Sql-Stmt", "{Alter-Table-Stmt}", weight=1.0)
ctx.rule("Sql-Stmt", "{Pragma-Stmt}", weight=1.0)
ctx.rule("Sql-Stmt", "{Analyze-Stmt}", weight=1.0)
ctx.rule("Sql-Stmt", "{Attach-Stmt}", weight=1.0)
# Layer 2 stress templates (elevated weights)
ctx.rule("Sql-Stmt", "{Deep-Nested-Select}", weight=1.0)
ctx.rule("Sql-Stmt", "{Long-Join-Chain}", weight=1.0)
ctx.rule("Sql-Stmt", "{Recursive-CTE-Heavy}", weight=1.0)
ctx.rule("Sql-Stmt", "{Window-Func-Complex}", weight=1.0)
ctx.rule("Sql-Stmt", "{Json-Deep}", weight=1.0)
ctx.rule("Sql-Stmt", "{Aggregate-Complex}", weight=1.0)
ctx.rule("Sql-Stmt", "{Explain-Stress}", weight=1.0)
# P7: Boundary-value function (replaces Printf-Boundary literal PoC rules)
ctx.rule("Sql-Stmt", "{Pattern-Boundary-Func}", weight=1.0)
# P1–P6: CVE structural patterns (multi-statement, self-contained DDL→DQL)
ctx.rule("Sql-Stmt", "{Pattern-DDL-DQL}", weight=1.0)
ctx.rule("Sql-Stmt", "{Pattern-GenCol-Op}", weight=1.0)
ctx.rule("Sql-Stmt", "{Pattern-Compound}", weight=1.0)
ctx.rule("Sql-Stmt", "{Pattern-Schema-Pragma}", weight=1.0)
...
ctx.rule("Table-Name", "p", weight=1.0)   # fresh-name: used in pattern rules
ctx.rule("Table-Name", "q", weight=1.0)
ctx.rule("Table-Name", "r", weight=1.0)
ctx.rule("Table-Name", "s", weight=1.0)
ctx.rule("Col-Name", "c1", weight=1.0)
ctx.rule("Col-Name", "c2", weight=1.0)
ctx.rule("Col-Name", "c3", weight=1.0)
ctx.rule("Col-Name", "a", weight=1.0)     # used in pattern DDL rules
ctx.rule("Col-Name", "b", weight=1.0)
ctx.rule("Col-Name", "rowid", weight=1.0)
ctx.rule("Col-Name", "_rowid_", weight=1.0)
...
ctx.rule("Deep-Expr", "{Expr} {Bin-Op} {Deep-Expr-L2}", weight=1.0)
ctx.rule("Deep-Expr", "({Deep-Expr-L2})", weight=1.0)
ctx.rule("Deep-Expr", "CAST({Deep-Expr-L2} AS {Type-Name})", weight=1.0)
ctx.rule("Deep-Expr", "CASE WHEN {Deep-Expr-L2} THEN {Deep-Expr-L2} ELSE {Expr} END", weight=1.0)
ctx.rule("Deep-Expr", "{Func-Call}", weight=1.0)

ctx.rule("Deep-Expr-L2", "{Expr} {Bin-Op} {Expr}", weight=1.0)
ctx.rule("Deep-Expr-L2", "({Expr} {Bin-Op} {Expr})", weight=1.0)
ctx.rule("Deep-Expr-L2", "{Func-Call}", weight=1.0)
...
ctx.rule("Win-Func-Expr", "row_number()", weight=1.0)
ctx.rule("Win-Func-Expr", "rank()", weight=1.0)
ctx.rule("Win-Func-Expr", "dense_rank()", weight=1.0)
ctx.rule("Win-Func-Expr", "lag({Expr}, {Int-Literal}, {Expr})", weight=1.0)
ctx.rule("Win-Func-Expr", "lead({Expr}, {Int-Literal}, {Expr})", weight=1.0)
...
ctx.rule("Win-Partition", "PARTITION BY {Expr}", weight=1.0)
ctx.rule("Win-Partition", "PARTITION BY {Expr}, {Expr}", weight=1.0)
ctx.rule("Win-Order", "", weight=1.0)
ctx.rule("Win-Order", "ORDER BY {Expr}", weight=1.0)
ctx.rule("Win-Order", "ORDER BY {Expr} {Asc-Desc}, {Expr}", weight=1.0)
ctx.rule("Win-Frame", "", weight=1.0)
ctx.rule("Win-Frame", "ROWS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW", weight=1.0)
...
ctx.rule("Boundary-Func-Call", "printf({Format-Spec}, {Boundary-Int}, {Boundary-Float})", weight=1.0)
ctx.rule("Boundary-Func-Call", "printf({Format-Spec}, {Boundary-Int})", weight=1.0)
ctx.rule("Boundary-Func-Call", "printf({Printf-Fmt-Spec}, {Boundary-Int}, {Str-Literal})", weight=1.0)
ctx.rule("Boundary-Func-Call", "substr({Str-Literal}, {Boundary-Int})", weight=1.0)
ctx.rule("Boundary-Func-Call", "substr({Str-Literal}, {Boundary-Int}, {Boundary-Int})", weight=1.0)
ctx.rule("Boundary-Func-Call", "hex(zeroblob({Boundary-Int}))", weight=1.0)
ctx.rule("Boundary-Func-Call", "round({Boundary-Float}, {Boundary-Int})", weight=1.0)

# Format-Spec: precision format specifiers (CVE-2020-13434 root cause class)
ctx.rule("Format-Spec", "'%.*g'", weight=1.0)  # CVE-2020-13434 root specifier
ctx.rule("Format-Spec", "'%.*f'", weight=1.0)
ctx.rule("Format-Spec", "'%.*e'", weight=1.0)
ctx.rule("Format-Spec", "'%.*d'", weight=1.0)
ctx.rule("Format-Spec", "'%.*s'", weight=1.0)

ctx.rule("Printf-Fmt-Spec", "'%d'", weight=1.0)
ctx.rule("Printf-Fmt-Spec", "'%u'", weight=1.0)
ctx.rule("Printf-Fmt-Spec", "'%x'", weight=1.0)
ctx.rule("Printf-Fmt-Spec", "'%f'", weight=1.0)
ctx.rule("Printf-Fmt-Spec", "'%s'", weight=1.0)
...
ctx.rule("Agg-Func", "count({Expr})", weight=1.0)
ctx.rule("Agg-Func", "sum({Expr})", weight=1.0)
...
ctx.rule("Agg-Func", "count(*)", weight=1.0)
...
ctx.rule("Boundary-Int", "2147483647", weight=1.0)      # INT32_MAX
ctx.rule("Boundary-Int", "2147483648", weight=1.0)      # INT32_MAX + 1
ctx.rule("Boundary-Int", "-2147483648", weight=1.0)     # INT32_MIN
ctx.rule("Boundary-Int", "-2147483649", weight=1.0)     # INT32_MIN - 1
ctx.rule("Boundary-Int", "4294967295", weight=1.0)      # UINT32_MAX
ctx.rule("Boundary-Int", "4294967296", weight=1.0)      # UINT32_MAX + 1
ctx.rule("Boundary-Int", "9223372036854775807", weight=1.0)   # INT64_MAX
ctx.rule("Boundary-Int", "-9223372036854775808", weight=1.0)  # INT64_MIN
ctx.rule("Boundary-Int", "0", weight=1.0)
ctx.rule("Boundary-Int", "-1", weight=1.0)
ctx.rule("Boundary-Int", "1", weight=1.0)

# Boundary-Float: float boundary values
ctx.rule("Boundary-Float", "0.01", weight=1.0)     # CVE-2020-13434 PoC value
ctx.rule("Boundary-Float", "0.0", weight=1.0)
ctx.rule("Boundary-Float", "1.0", weight=1.0)
ctx.rule("Boundary-Float", "-1.0", weight=1.0)
ctx.rule("Boundary-Float", "1e308", weight=1.0)
ctx.rule("Boundary-Float", "-1e308", weight=1.0)
...
ctx.rule("GenCol-Expr", "a", weight=1.0)
ctx.rule("GenCol-Expr", "a + {Int-Literal}", weight=1.0)
ctx.rule("GenCol-Expr", "coalesce(a, b)", weight=1.0)
ctx.rule("GenCol-Expr", "a = {Int-Literal}", weight=1.0)
...
ctx.rule("Compound-Op-Set", "INTERSECT", weight=1.0)
ctx.rule("Compound-Op-Set", "EXCEPT", weight=1.0)
...
ctx.rule("Window-Agg-Expr", "count() OVER ({Win-Partition} {Win-Order})", weight=1.0)
ctx.rule("Window-Agg-Expr", "sum({Col-Ref}) OVER ({Win-Order})", weight=1.0)
ctx.rule("Window-Agg-Expr", "lead({Col-Ref}) OVER ({Win-Order})", weight=1.0)
ctx.rule("Window-Agg-Expr", "lag({Col-Ref}) OVER ({Win-Order})", weight=1.0)
