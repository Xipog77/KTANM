# sqlite_v4_prod.py — Production attack surface grammar for Nautilus SQLite fuzzing
# Version: v4.0a (zero-day hunting on SQLite 3.53.0, PRODUCTION code paths only)
#
